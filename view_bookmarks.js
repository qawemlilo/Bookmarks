...
var HACKER_BOOKMARKS = { 
 ...
 window.callBack_89cvc7rfr742 = function(o) {	
  ...
  HACKER_BOOKMARKS.getBookmarks(g_url, "callBack_89cvc7rfr742");
>>>>>>> a93ef4dcdf19b343914cf72a940d96d432e57d7d
...
var HACKER_BOOKMARKS = { 
    ...
    createPanel: function (id, opts) {
    	...
    	// Applying styles: 
		    ...
		    top = '0px';
			padding = '4px;';
		    overflowY = opts.yOverflow || 'scroll';
		    borderLeft = '2px ridge #f7f7f7';
		    overflowX = opts.xOverflow || 'hidden';
		    right = '0px';
		    backgroundColor = opts.bgColor || '#f7f7f7';
		    color = '#777';
		    fontFamily = opts.font || '"Myriad Pro",Arial,Helvetica,sans-serif';
...
// password-like call back function name to avoid over-writing any variables
 window.ghshu_897742 = function(o) {	
      var elem = document.getElementById('hacker_bookmark_panel'), bmHTML;
